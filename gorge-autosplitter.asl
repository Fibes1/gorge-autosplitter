...
// changes when a vhs tape is collected, does not require achievements to be reset
    byte challengeCheck: 0x035E0228, 0x8, 0x378, 0x30;
// number of challenge courses completed in under par time
    int mugCheck: 0x035E0228, 0x8, 0x360, 0xA0;
// number of mugs collected
    int lookoutCheck: 0x035E0228, 0x8, 0x360, 0xD0;
// number of lookouts visited
    int vhs2Check: 0x035E0228, 0x8, 0x360, 0x140;
// number of vhs tapes collected
}
